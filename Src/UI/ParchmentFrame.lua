...
function ParchmentFrame:initialize()
    ...
    ---@type Frame
    local borderFrame = Frame()
    borderFrame:SetParent(self)
    borderFrame:SetAllPoints(self)
    borderFrame:SetFrameLevel(UILayers.PARCHMENT_BORDERS)
    --region Corners

    local TopLeftCorner = borderFrame:CreateTexture()
    ...
    local TopRightCorner = borderFrame:CreateTexture()
    ...
    local BottomRightCorner = borderFrame:CreateTexture()
    ...
    local BottomLeftCorner = borderFrame:CreateTexture()
    ...
    local TopBorder = borderFrame:CreateTexture()
    ...
    local BottomBorder = borderFrame:CreateTexture()
    ...
    local LeftBorder = borderFrame:CreateTexture()
    ...
    local RightBorder = borderFrame:CreateTexture()
    ...
    local LeftTopHide = borderFrame:CreateTexture()
    ...
    local LeftBottomHide = borderFrame:CreateTexture()
    ...
    local RightTopHide = borderFrame:CreateTexture()
    ...
    local RightBottomHide = borderFrame:CreateTexture()
    ...
    local BottomRightHide = borderFrame:CreateTexture()
    ...
    local BottomLeftHide = borderFrame:CreateTexture()
    ...
    local TopRightHide = borderFrame:CreateTexture()
    ...
    local TopLeftHide = borderFrame:CreateTexture()
    ...
    backgroundFrame:SetParent(self)
    backgroundFrame:SetAllPoints(self)
    backgroundFrame:SetFrameLevel(UILayers.BACKGROUND)
